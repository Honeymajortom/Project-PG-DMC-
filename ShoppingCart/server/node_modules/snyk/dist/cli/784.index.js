...
Object.defineProperty(exports, "spinnerFailureMessage", ({ enumerable: true, get: function () { return v2_1.spinnerFailureMessage; } }));
...
function formatIacTestFailures(testFailures) {
    ...
    const titleOutput = color_utils_1.colors.info.bold(`Test Failures`);
...
Object.defineProperty(exports, "spinnerFailureMessage", ({ enumerable: true, get: function () { return user_messages_1.spinnerFailureMessage; } }));
...
function formatCountsSection(testData) {
    ...
    countsSectionProperties.push(`${INDENT}Invalid files: ${color_utils_1.colors.info.bold(`${(_b = (_a = testData.failures) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0}`)}`);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.shouldLogUserMessages = exports.spinnerFailureMessage = exports.spinnerSuccessMessage = exports.spinnerMessage = exports.iacTestTitle = void 0;
const color_utils_1 = __webpack_require__(4960);
/**
 * Displayed as the title of the test output.
 */
exports.iacTestTitle = color_utils_1.colors.info.bold('Snyk Infrastructure as Code');
/**
 * Progress indication message while files are tested.
 */
exports.spinnerMessage = color_utils_1.colors.info('Snyk testing Infrastructure as Code configuration issues.');
/**
 * Displayed when a test resolves successfully.
 */
exports.spinnerSuccessMessage = color_utils_1.colors.info('Test completed.');
/**
 * Displayed when a test fails.
 */
exports.spinnerFailureMessage = color_utils_1.colors.info('Unable to complete the test.');
/**
